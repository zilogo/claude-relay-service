<template>
  <div class="card p-3 sm:p-6">
    <div class="mb-4 sm:mb-8">
      ...
      >
        <i class="fas fa-graduation-cap mr-2 text-[#D97757] sm:mr-3" />
        Claude Code 使用教程
      </h3>
        ...
        <button
          ...
          :class="[
            ...
            activeTutorialSystem === system.key
              ? 'bg-white text-[#D97757] shadow-sm dark:bg-[#D97757] dark:text-white dark:shadow-[#D97757]/40'
    ...
    <div v-if="activeTutorialSystem === 'windows'" class="tutorial-content">
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-[#D97757] text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >1</span
          >
          安装 Node.js 环境
        </h4>
        ...
        <div
          class="mb-4 rounded-xl border border-[#D97757]/20 bg-gradient-to-r from-[#D97757]/5 to-[#D97757]/10 p-4 dark:border-[#D97757]/40 dark:from-[#D97757]/10 dark:to-[#D97757]/15 sm:mb-4 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <i class="fab fa-windows mr-2 text-[#D97757]" />
            Windows 安装方法
          </h5>
          ...
          <div
            class="rounded-lg border border-[#D97757]/40 bg-[#D97757]/5 p-3 dark:border-[#D97757]/40 dark:bg-[#D97757]/10 sm:p-4"
          >
            <h6 class="mb-2 text-sm font-medium text-[#D97757] dark:text-[#D97757] sm:text-base">
              Windows 注意事项
            </h6>
            <ul class="space-y-1 text-xs text-[#D97757] dark:text-[#D97757] sm:text-sm sm:text-xs">
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          ...
          <div
            class="mt-4 rounded-lg border border-[#D97757]/40 bg-[#D97757]/5 p-3 dark:border-[#D97757]/40 dark:bg-[#D97757]/10 sm:p-4"
          >
            <h6 class="mb-2 text-sm font-medium text-[#D97757] dark:text-[#D97757] sm:text-base">
              提示
            </h6>
            <ul class="space-y-1 text-xs text-[#D97757] dark:text-[#D97757] sm:text-sm">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        >
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <p class="mt-2 text-xs text-[#D97757] dark:text-[#D97757]">
        ...
        >
          <h6 class="mb-2 font-medium text-[#D97757] dark:text-[#D97757]">验证环境变量设置</h6>
          <p class="mb-3 text-sm text-[#D97757] dark:text-[#D97757]">
          ...
          <div class="mt-3 space-y-2">
            <p class="text-sm text-[#D97757] dark:text-[#D97757]">
...
/* 注意事项框 - 橙棕色系列 */
html.dark :deep(.border-\[\#D97757\]\/40) {
  border-color: rgba(217, 119, 87, 0.5) !important;
}

html.dark :deep(.bg-\[\#D97757\]\/5) {
...
/* 彩色文字优化 - 用户页面主题色 */
html.dark :deep(.text-\[\#D97757\]) {
  color: #f0a78d !important; /* 橙棕色的亮色版本 */
}
...
html.dark :deep(.border-\[\#D97757\]\/20) {
